...
describe('extractFechaPago', () => {
  ...
  it('M1: Múltiples labels', () => {
    expect(extractFechaPago('FECHA Y HORA\\n07/05/2026 10:00AM')).toBe('2026-05-07');
    expect(extractFechaPago('DATE\\n08/05/2026')).toBe('2026-05-08');
  });

  it('M2: Múltiples formatos', () => {
    expect(extractFechaPago('FECHA\\n06-05-2026')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n06.05.2026')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n2026-05-06')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n06/05/26')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n06 de mayo de 2026')).toBe('2026-05-06');
  });

  it('M3: Separadores OCR', () => {
    expect(extractFechaPago('FECHA\\n06l05l2026')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n06I05I2026')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n06|05|2026')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n0610512026')).toBe('2026-05-06');
  });

  it('M4: Dígitos OCR', () => {
    expect(extractFechaPago('FECHA\\nO6/O5/2O26')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\nQ6/05/2026')).toBe('2026-05-06');
  });
  ...
  it('M6: Scoring por label', () => {
    expect(extractFechaPago('FECHA\\n06/05/2026\\nOtra fecha irrelevante 10/10/2026')).toBe('2026-05-06');
  });
  ...
  it('M8: Recorte de hora', () => {
    expect(extractFechaPago('FECHA\\n06/05/202602:50:03AM')).toBe('2026-05-06');
    expect(extractFechaPago('FECHA\\n06/05/202614:30:00')).toBe('2026-05-06');
  });
