...
const req = http.request("http://167.172.217.151:3000/api/trpc/auth.login?batch=1", {
    method: "POST",
    headers: {
    ...
    res.on('end', () => {
        try {
            ...
            const req2 = http.request("http://167.172.217.151:3000/api/trpc/services.deployApp?batch=1", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
