#!/bin/bash
echo "📦 Writing Part 3: Stories Generator Page..."

# app/admin/stories-results/page.tsx
mkdir -p app/admin/stories-results
cat << 'EOF' > app/admin/stories-results/page.tsx
'use client';
