#!/bin/bash
# Part 13: Remove Ranking & Enhance Message Display in Instagram Config
# Updates app/admin/instagram-config/page.tsx to remove the Top 5 section and use that space for larger, more prominent messages.
                    ...
                    <div className="relative flex flex-col items-center w-full max-w-lg" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="text-white/30 text-xs mt-6 text-center">
                            * Captura esta pantalla para usar en Instagram. <br/>
                            Data en vivo desde la base de datos (Sin Ranking).
                        </p>
                    </div>
                </div>
            )}
